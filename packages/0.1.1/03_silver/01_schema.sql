...
--   * `investments`         — 17 current entities (8 SCD2 dims + 1 fx_rate_dim + 8 base facts).
...
CREATE SCHEMA IF NOT EXISTS investments
    COMMENT 'Silver — current. SCD2 dims (security/security_rating/contract/portfolio/entity/security_industry/reporting_group/business_unit) + fx_rate_dim + 8 base facts. References bronze for source.';
