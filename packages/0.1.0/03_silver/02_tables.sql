...
CREATE TABLE IF NOT EXISTS investments.t_vposition_monthend_fact (
...
CREATE TABLE IF NOT EXISTS investments.t_vportfolio_analytics_monthend_fact (
...
CREATE TABLE IF NOT EXISTS investments.t_vcontract_details_cancels_fact (
...
CREATE TABLE IF NOT EXISTS investments.t_vposition_cancels_fact (
    cancel_sk                     BIGINT       NOT NULL,
...
CREATE TABLE IF NOT EXISTS investments.t_vsecurity_price_cancels_fact (
    cancel_sk                     BIGINT       NOT NULL,
...
-- 2.23 vincome_bridge ----------------------------------------------------------
CREATE TABLE IF NOT EXISTS investments.t_vincome_bridge (
