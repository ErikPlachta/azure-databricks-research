...
CREATE OR REPLACE VIEW investments.vposition_monthend_fact AS
WITH monthends AS (
    SELECT
...
CREATE OR REPLACE VIEW investments.vportfolio_analytics_monthend_fact AS
WITH aggregated AS (
    SELECT
...
CREATE OR REPLACE VIEW investments.vcontract_details_cancels_fact AS
WITH amendments AS (
...
CREATE OR REPLACE VIEW investments.vposition_cancels_fact AS
WITH p_resolved AS (
...
CREATE OR REPLACE VIEW investments.vsecurity_price_cancels_fact AS
SELECT
...
CREATE OR REPLACE VIEW investments.vincome_bridge AS
WITH cf_resolved AS (
